...
const Resume = forwardRef((props, ref) => {
  ...
  const info = {
    ...
    certifications: information[sections.certifications],
  ...
  const sectionDiv = {
    ...
    [sections.certifications]: (
      <div
        key={"certifications"}
        draggable
        onDragOver={() => seTarget(info.certifications?.id)}
        onDragEnd={() => setSource(info.certifications?.id)}
        className={`${styles.section} ${
          info.certifications?.sectionTitle ? "" : styles.hidden
        }`}
      >
        <div className={styles.sectionTitle}>{info.certifications.sectionTitle}</div>
        <div className={styles.content}>
          {info.certifications?.details?.map((item) => (
            <div className={styles.item}>
              {item.title ? (
                <p className={styles.title}>{item.title}</p>
              ) : (
  ...
  useEffect(() => {
    setColumns([
      ...
      [sections.workExp, sections.achievement,sections.skills,
        sections.certifications, sections.other],
    ]);
  }, []);
